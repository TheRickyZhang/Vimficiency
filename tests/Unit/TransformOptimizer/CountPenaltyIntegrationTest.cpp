...
TEST(EditCountPenaltyIntegrationTest, CountedLineEditsIncludeRuntimePenalty) {
  ...
  TransformOptimizerParams params = TransformOptimizerParams{}.withMinCountRepeat(2);
  EffortBank bank(config);
  TransformExplorer explorer(boundary, params, config, bank, boundary.leftColOffset(),
