...
struct MotionOptimizerParams : OptimizerParamsBase {
  ...
  MotionOptimizerParams& withMaxTotalPops(int v) { maxTotalPops = v; return *this; }
  ...
  static MotionOptimizerParams dijkstra(int maxResults = 10, int maxTotalPops = 50000) {
...
struct MotionOptimizerRangeParams : MotionOptimizerParams {
  ...
  MotionOptimizerRangeParams& withMaxTotalPops(int v) { maxTotalPops = v; return *this; }
