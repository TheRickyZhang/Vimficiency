...
bool ChangeGoalHandler::isDotRepeat(const EditState& base, const SequenceBinding& sourceCmd) const {
...
GoalStates ChangeGoalHandler::emitEditGoal(
    EditState& postCompletionState, const EditState& base,
    const SequenceBinding& sourceCmd,
...
GoalStates ChangeGoalHandler::emitLinewiseChangeGoal(
    EditState& afterDel, const EditState& base,
...
GoalStates ChangeGoalHandler::onLinewiseGoal(
    EditState& afterDel, const EditState& base, LineRange range,
    const SequenceBinding& sourceCmd) {
...
GoalStates ChangeGoalHandler::onJoinGoal(
    EditState& afterJn, const EditState& base,
    const SequenceBinding& sourceCmd) {
  bool isDot = isDotRepeat(base, sourceCmd);
...
EditResult ChangeGoalHandler::finalize(
